...
var NotPxDefaultProperties, tideEventKey, valid, __idClassKey, __localTags,
...
x.module = function(name, m) {
  ...
  return m[x.f.id] = m.fn && m.fn[x.f.id] || function(id) {
    if (id[0] === '#') {
...
x.isModule = function(m) {
  return x.isObject(m) && x.f.id in m && 'label' in m;
};
