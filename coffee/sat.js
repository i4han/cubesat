...
(function() {
  var ionBlockTags, ionInsertTags;
  ...
  fs.readdir(test_path, function(e, list) {
    ...
    return fs.readdir(site_path, function(e, list) {
      return e || list.forEach(function(f) {
        ...
        return ((_ref2 = path.extname(f)) === '.coffee' || _ref2 === '.js') && fs.link(add(site_path, f), add(test_path, f), function() {
