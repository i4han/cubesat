...
var NotPxDefaultProperties, indent_string, keyFix, tideEventKey, tideKey, valid, validateRe,
...
x.module = function(name, m) {
  ...
  m.block = m.block || 'x';
  (m.fn = x.func(m.fn, m)) && x.keys(m.fn).forEach(function(f) {
    return m[f] = m.fn[f];
  });
