...
Meteor.startup(function() {
  ...
  x.keys(exports).filter(function(k) {
    ...
    return x.extend(Modules, x.func(exports[f].Modules));
  });
  x.keys(this.Modules = Modules).map(function(n) {
    return x.module.call(this, n, Modules[n] = x.func(Modules[n], x.func(Modules[n])));
  });
  if (Meteor.isServer) {
    ...
    return x.keys(Modules).map(function(n) {
      ...
      _.methods && Meteor.methods(x.func(_.methods, _));
      _.collections && mongoServer(x.func(_.collections, _), _);
    ...
    x.keys(Modules).map(function(n) {
      ...
      _.events && Template[n].events(x.tideEventKey(x.func(_.events, _), _.Id));
      _.helpers && Template[n].helpers(x.func(_.helpers, _));
      _.on$Ready && $(function($) {
