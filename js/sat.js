...
style_path = env('STYLE_PATH') || add(site_path, 'style');
...
test = function() {
  return console.log('Arguments', argv);
};

version = function() {
  return console.log('sat version:', '0.4.13');
};
