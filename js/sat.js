...
fixup = function(v) {
  ...
  switch (false) {
    ...
    case !__.isObject(v):
      return __.reduceKeys(v, {}, function(o, k) {
        if ('$' === k[0] && k in Parts) {
...
toStyle = function(d) {
  ...
  return cssDefaults(__.reduceKeys((obj = fixup.call(this, this[d])), {}, function(o, k) {
...
isHtmlAttribute = function(obj) {
  ...
  return __.isObject(obj) && (_ref2 = __.theKey(obj), __indexOf.call(htmlAttributes, _ref2) >= 0);
};
...
tagLine = function(tag, obj, str) {
  ...
  switch (false) {
    ...
    case !(__.check('id', k) && __indexOf.call(keys, newTab) >= 0):
    ...
    case !__.check('id', k):
      ...
      return __.reduceKeys(obj, '', function(o, v) {
