...
fixup = function(v) {
  ...
  switch (false) {
    ...
    case !x.isObject(v):
      return x.reduceKeys(v, {}, (function(_this) {
        return function(o, k) {
          if (Parts && k in Parts) {
...
styleLoop = function(obj) {
  return x.reduceKeys(obj, {}, (function(_this) {
    return function(o, k) {
      var idk;
      switch (false) {
        case k[0] !== '@':
...
toStyle = function(d) {
  var obj;
  return cssDefaults(x.reduceKeys((obj = fixup.call(this, this[d])), {}, (function(_this) {
    return function(o, k) {
...
['$each', '$with'].forEach(function(tag) {
  return global[tag] = function(obj) {
    var key;
    return '{{#' + tag.slice(1) + ' ' + (key = x.keys(obj)[0]) + '}}\n' + x.indent(obj[key]) + '\n{{/' + tag.slice(1) + '}}';
  };
});
...
global.$include = function() {
  var args;
  return x.reduce((args = [].slice.call(arguments)), [], function(o, arg) {
    var k;
    return x.array(o, (function() {
      switch (false) {
        case !x.isObject(arg):
          return '{{> ' + (k = x.keys(arg)[0]) + includeAttributes(arg[k]) + '}}';
        case !x.isString(arg):
          return '{{> ' + arg + '}}';
        default:
          return console.error('Invalid `include` arguments', args[0], arg);
      }
    })());
  }).join('\n');
};
